...
end1
cat differentiators.pug >> newFile.pug
mv -f newFile.pug  differentiators.pug
...
end3
cat differentiators.scss >> newFile.scss
mv -f newFile.scss differentiators.scss
cd ${fileName}
