...
end1
cat request-form.pug >> newFile.pug
mv -f newFile.pug  request-form.pug
...
end3
cat request-form.scss >> newFile.scss
mv -f newFile.scss request-form.scss
cd ${fileName}
