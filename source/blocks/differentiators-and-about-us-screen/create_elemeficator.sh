#!/bin/sh
parentName=differentiators-and-about-us-screen
...
end1
cat differentiators-and-about-us-screen.pug >> newFile.pug
mv -f newFile.pug  differentiators-and-about-us-screen.pug
...
end3
cat differentiators-and-about-us-screen.scss >> newFile.scss
mv -f newFile.scss differentiators-and-about-us-screen.scss
cd ${fileName}
